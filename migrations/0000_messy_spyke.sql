...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "user_finances" ADD CONSTRAINT "user_finances_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
